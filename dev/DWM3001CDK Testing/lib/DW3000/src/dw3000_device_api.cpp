 ...
 */
int32_t DW3000::dwt_apiversion(void)
{
 ...
 * @param tx_buffer     - pointer to buffer containing the 'length' bytes to be written (ONLY used in read mode)
 * @param rx_buffer     - pointer to buffer containing the 'length' bytes to be read (ONLY used in write mode)
 * @param rw            - DW3000_SPI_WR_BIT/DW3000_SPI_RD_BIT
 *
 * no return value
 */
void DW3000::dwt_xfer3000(
	...
	spi_modes_e mode)
{
	...
	{
		{
			writetospi(cnt, header, length, tx_buffer);
		}
		break;
	}
	case DW3000_SPI_RD_BIT:
	{
		readfromspi(cnt, header, length, rx_buffer);
		break;
	}
	default:
		while (1)
 ...
 * no return value
 */
void DW3000::dwt_writetodevice(
	uint32_t regFileID,
	uint16_t index,
	uint16_t length,
	const uint8_t *buffer)
{
	dwt_xfer3000(regFileID, index, length, buffer, nullptr, DW3000_SPI_WR_BIT);
}
 ...
 * no return value
 */
void DW3000::dwt_wakeup_ic(void)
{
 ...
 * no return value
 */
void DW3000::dwt_readfromdevice(
	uint32_t regFileID,
	uint16_t index,
	uint16_t length,
	uint8_t *buffer)
{
	dwt_xfer3000(regFileID, index, length, nullptr, buffer, DW3000_SPI_RD_BIT);
}
 ...
 */
uint32_t DW3000::dwt_read32bitoffsetreg(uint32_t regFileID, uint16_t regOffset)
{
	int j;
	uint32_t regval = 0;
	uint8_t buffer[4];
 ...
 */
uint16_t DW3000::dwt_read16bitoffsetreg(uint32_t regFileID, uint16_t regOffset)
{
	uint16_t regval = 0;
	uint8_t buffer[2];
 ...
 */
uint8_t DW3000::dwt_read8bitoffsetreg(uint32_t regFileID, uint16_t regOffset)
{
	uint8_t regval;
	uint8_t buffer[1];
 ...
 * no return value
 */
void DW3000::dwt_write32bitoffsetreg(uint32_t regFileID, uint16_t regOffset, uint32_t regval)
{
	int j;
	uint8_t buffer[4];
 ...
 * no return value
 */
void DW3000::dwt_write16bitoffsetreg(uint32_t regFileID, uint16_t regOffset, uint16_t regval)
{
	uint8_t buffer[2];
 ...
 * no return value
 */
void DW3000::dwt_write8bitoffsetreg(uint32_t regFileID, uint16_t regOffset, uint8_t regval)
{
	uint8_t buffer[1];
	buffer[0] = regval;
 ...
 */
void DW3000::dwt_modify32bitoffsetreg(const uint32_t regFileID, const uint16_t regOffset, const uint32_t _and, const uint32_t _or)
{
	uint8_t buf[8];
	...
	dwt_xfer3000(regFileID, regOffset, sizeof(buf), buf, nullptr, DW3000_SPI_AND_OR_32);
}
 ...
 * @output          :   no return value
 */
void DW3000::dwt_modify16bitoffsetreg(const uint32_t regFileID, const uint16_t regOffset, const uint16_t _and, const uint16_t _or)
{
	uint8_t buf[4];
	buf[0] = (uint8_t)_and;		   //       &0xFF;
	buf[1] = (uint8_t)(_and >> 8); //  &0xFF;
	...
	dwt_xfer3000(regFileID, regOffset, sizeof(buf), buf, nullptr, DW3000_SPI_AND_OR_16);
}
 ...
 * @output          :   no return value
 */
void DW3000::dwt_modify8bitoffsetreg(const uint32_t regFileID, const uint16_t regOffset, const uint8_t _and, const uint8_t _or)
{
	uint8_t buf[2];
	buf[0] = _and;
	buf[1] = _or;
	dwt_xfer3000(regFileID, regOffset, sizeof(buf), buf, nullptr, DW3000_SPI_AND_OR_8);
}

void DW3000::_dwt_crc8init(void)
{
	uint8_t remainder;
	int dividend;
 ...
 */
uint8_t DW3000::dwt_generatecrc8(const uint8_t *byteArray, uint8_t len, uint8_t crcRemainderInit)
{
	uint8_t data;
	int byte;
 ...
 * no return value
 */
void DW3000::dwt_enablespicrccheck(dwt_spi_crc_mode_e crc_mode, dwt_spierrcb_t spireaderr_cb)
{
...
void DW3000::_dwt_prog_ldo_and_bias_tune(void)
{
 ...
 * no return value
 */
void DW3000::_dwt_kick_ops_table_on_wakeup(void)
{
 ...
 * no return value
 */
void DW3000::_dwt_kick_dgc_on_wakeup(int8_t channel)
{
 ...
 */
int DW3000::dwt_initialise(uint8_t mode)
{
	//uint16_t otp_addr;
	//uint32_t devid;
 ...
 * no return value
 */
void DW3000::dwt_setdwstate(uint8_t state)
{
 ...
 * no return value
 */
void DW3000::dwt_enablegpioclocks(void)
{
 ...
 */
uint8_t DW3000::dwt_otprevision(void)
{
 ...
 * no return value
 */
void DW3000::dwt_setfinegraintxseq(uint8_t enable)
{
	if (enable)
	{
 ...
 * no return value
 */
void DW3000::dwt_setlnapamode(uint8_t lna_pa)
{
 ...
 * returns uint8_t
 */
uint8_t DW3000::dwt_readpgdelay(void)
{
 ...
 */
uint8_t DW3000::dwt_geticrefvolt(void)
{
 ...
 */
uint8_t DW3000::dwt_geticreftemp(void)
{
 ...
 */
uint32_t DW3000::dwt_getpartid(void)
{
 ...
 */
uint32_t DW3000::dwt_getlotid(void)
{
 ...
 */
uint32_t DW3000::dwt_readdevid(void)
{
 ...
 * no return value
 */
void DW3000::dwt_configuretxrf(const dwt_txconfig_t *config)
{
	if (config->PGcount == 0)
	{
 ...
 * no return value
 */
void DW3000::dwt_configurestskey(dwt_sts_cp_key_t *pStsKey)
{
 ...
 * no return value
 */
void DW3000::dwt_configurestsiv(dwt_sts_cp_iv_t *pStsIv)
{
 ...
 * no return value
 */
void DW3000::dwt_configurestsloadiv(void)
{
	dwt_or8bitoffsetreg(STS_CTRL_ID, 0, STS_CTRL_LOAD_IV_BIT_MASK);
}

uint16_t DW3000::get_sts_mnth(uint16_t cipher, uint8_t threshold, uint8_t shift_val)
{
	uint32_t value;
	uint16_t mod_val;
 ...
 * no return value
 */
void DW3000::dwt_configmrxlut(uint8_t channel)
{
 ...
 *
 */
void DW3000::dwt_restoreconfig(void)
{
	uint8_t channel = 5;
	uint16_t chan_ctrl;
 ...
 *
 */
void DW3000::dwt_configurestsmode(uint8_t stsMode)
{
 ...
 *
 */
int DW3000::dwt_configure(const dwt_config_t *config)
{
	...
	// if (config->sfdTO == 0) //we shouldn't modify this so we can keep the refrence to it constant in the method
	// {
	// 	config->sfdTO = DWT_SFDTOC_DEF;
	// }
	uint16_t sfdTO = (config->sfdTO == 0) ? DWT_SFDTOC_DEF : config->sfdTO;	
	dwt_write16bitoffsetreg(DTUNE0_ID, 2, sfdTO);
 ...
 *
 */
int DW3000::dwt_pgf_cal(uint8_t ldoen)
{
	uint8_t temp;
	uint16_t val;
 ...
 *
 */
int DW3000::dwt_run_pgfcal(void)
{
 ...
 * no return value
 */
void DW3000::dwt_setrxantennadelay(uint16_t rxDelay)
{
 ...
 * no return value
 */
void DW3000::dwt_settxantennadelay(uint16_t txDelay)
{
 ...
 * returns DWT_SUCCESS for success, or DWT_ERROR for error
 */
int DW3000::dwt_writetxdata(uint16_t txDataLength, const uint8_t *txDataBytes, uint16_t txBufferOffset)
{
#ifdef DWT_API_ERROR_CHECK
 ...
 * no return value
 */
void DW3000::dwt_writetxfctrl(uint16_t txFrameLength, uint16_t txBufferOffset, uint8_t ranging)
{
	uint32_t reg32;
#ifdef DWT_API_ERROR_CHECK
 ...
 * no return value
 */
void DW3000::dwt_setplenfine(uint8_t preambleLength)
{
 ...
 * no return value
 */
void DW3000::dwt_read_rx_scratch_data(uint8_t *buffer, uint16_t length, uint16_t rxBufferOffset)
{
 ...
 * no return value
 */
void DW3000::dwt_readrxdata(uint8_t *buffer, uint16_t length, uint16_t rxBufferOffset)
{
 ...
 * no return value
 */
void DW3000::dwt_readaccdata(uint8_t *buffer, uint16_t length, uint16_t accOffset)
{
 ...
 */
int16_t DW3000::dwt_readclockoffset(void)
{
	uint16_t regval = 0;
 ...
 */
int32_t DW3000::dwt_readcarrierintegrator(void)
{
	uint32_t regval = 0;
 ...
 */
int DW3000::dwt_readstsquality(int16_t *rxStsQualityIndex)
{
 ...
 */
int DW3000::dwt_readstsstatus(uint16_t *stsStatus, uint8_t sts_num)
{
	int ret = DWT_SUCCESS;
 ...
 * no return value
 */
void DW3000::dwt_readdiagnostics(dwt_rxdiag_t *diagnostics)
{
	int i;
	int offset_0xd;
 ...
 * no return value
 */
void DW3000::dwt_readtxtimestamp(uint8_t *timestamp)
{
 ...
 */
uint32_t DW3000::dwt_readtxtimestamphi32(void)
{
 ...
 */
uint32_t DW3000::dwt_readtxtimestamplo32(void)
{
 ...
 * no return value
 */
int16_t DW3000::dwt_readpdoa(void)
{
	int16_t pdoa;
 ...
 * no return value
 */
void DW3000::dwt_readtdoa(uint8_t *tdoa)
{
 ...
 * no return value
 */
void DW3000::dwt_readrxtimestamp(uint8_t *timestamp)
{
	switch (pdw3000local->dblbuffon) // check if in double buffer mode and if so which buffer host is currently accessing
	{
	case DBL_BUFF_ACCESS_BUFFER_1:
 ...
 * no return value
 */
void DW3000::dwt_readrxtimestampunadj(uint8_t *timestamp)
{
	timestamp[0] = 0;
 ...
 * no return value
 */
void DW3000::dwt_readrxtimestamp_ipatov(uint8_t *timestamp)
{
	switch (pdw3000local->dblbuffon) // check if in double buffer mode and if so which buffer host is currently accessing
	{
	case DBL_BUFF_ACCESS_BUFFER_1:
 ...
 * no return value
 */
void DW3000::dwt_readrxtimestamp_sts(uint8_t *timestamp)
{
	switch (pdw3000local->dblbuffon) // check if in double buffer mode and if so which buffer host is currently accessing
	{
	case DBL_BUFF_ACCESS_BUFFER_1:
 ...
 */
uint32_t DW3000::dwt_readrxtimestamphi32(void)
{
 ...
 */
uint32_t DW3000::dwt_readrxtimestamplo32(void)
{
 ...
 */
uint32_t DW3000::dwt_readsystimestamphi32(void)
{
 ...
 * no return value
 */
void DW3000::dwt_readsystime(uint8_t *timestamp)
{
 ...
 * no return value
 */
void DW3000::dwt_configureframefilter(uint16_t enabletype, uint16_t filtermode)
{
 ...
 * no return value
 */
void DW3000::dwt_setpanid(uint16_t panID)
{
 ...
 * no return value
 */
void DW3000::dwt_setaddress16(uint16_t shortAddress)
{
 ...
 * no return value
 */
void DW3000::dwt_seteui(uint8_t *eui64)
{
 ...
 * no return value
 */
void DW3000::dwt_geteui(uint8_t *eui64)
{
 ...
 */
uint8_t DW3000::dwt_aon_read(uint16_t aon_address)
{
 ...
 *
 */
void DW3000::dwt_aon_write(uint16_t aon_address, uint8_t aon_write_data)
{
	uint8_t temp = 0;
 ...
 * no return value
 */
void DW3000::dwt_otpread(uint16_t address, uint32_t *array, uint8_t length)
{
	int i;
 ...
 */
uint32_t DW3000::_dwt_otpread(uint16_t address)
{
	uint32_t ret_data;
 ...
 */
void DW3000::__dwt_otp_write_wdata_id_reg(int16_t val)
{
 ...
 * returns None
 */
void DW3000::_dwt_otpprogword32(uint32_t data, uint16_t address)
{
	// uint32_t rd_buf;
	uint16_t wr_buf[4];
	// uint8_t otp_done;
 ...
 * returns DWT_SUCCESS for success, or DWT_ERROR for error
 */
int DW3000::dwt_otpwriteandverify(uint32_t value, uint16_t address)
{
	// program the word
...
int DW3000::dwt_otpverify(uint32_t value, uint16_t address)
{
	// check it is programmed correctly
	if (_dwt_otpread(address) == value)
	{
 ...
 * no return value
 */
void DW3000::dwt_entersleep(uint8_t idle_rc)
{
 ...
 * no return value
 */
void DW3000::dwt_configuresleepcnt(uint16_t sleepcnt)
{
 ...
 */
uint16_t DW3000::dwt_calibratesleepcnt(void)
{
	uint16_t temp = 0;
 ...
 * no return value
 */
void DW3000::dwt_configuresleep(uint16_t mode, uint8_t wake)
{
 ...
 * no return value
 */
void DW3000::dwt_clearaonconfig(void)
{
 ...
 * no return value
 */
void DW3000::dwt_entersleepaftertx(uint8_t enable)
{
 ...
 * returns DWT_SUCCESS for success, or DWT_ERROR for error
 */
int DW3000::dwt_check_dev_id(void)
{
	uint32_t dev_id;
 ...
 * no return value
 */
void DW3000::dwt_configciadiag(uint8_t enable_mask)
{
 ...
 * no return value
 */
void DW3000::dwt_enableautoack(uint8_t responseDelayTime, uint8_t enable)
{
 ...
 * no return value
 */
void DW3000::dwt_signal_rx_buff_free(void)
{
 ...
 * no return value
 */
void DW3000::dwt_setdblrxbuffmode(dwt_dbl_buff_state_e dbl_buff_state, dwt_dbl_buff_mode_e dbl_buff_mode)
{
 ...
 * no return value
 */
void DW3000::dwt_setrxaftertxdelay(uint32_t rxDelayTime)
{
 ...
 * no return value
 */
void DW3000::dwt_setcallbacks(dwt_cb_t cbTxDone, dwt_cb_t cbRxOk, dwt_cb_t cbRxTo, dwt_cb_t cbRxErr, dwt_cb_t cbSPIErr, dwt_cb_t cbSPIRdy)
{
 ...
 */
uint8_t DW3000::dwt_checkirq(void)
{
 ...
 */
uint8_t DW3000::dwt_checkidlerc(void)
{
 ...
 * no return value
 */
void DW3000::dwt_setleds(uint8_t mode)
{
	uint32_t reg;
 ...
 * no return value
 */
void DW3000::dwt_force_clocks(int clocks)
{
 ...
 * no return value
 */
void DW3000::dwt_setreferencetrxtime(uint32_t reftime)
{
 ...
 * no return value
 */
void DW3000::dwt_setdelayedtrxtime(uint32_t starttime)
{
 ...
 */
int DW3000::dwt_starttx(uint8_t mode)
{
	...
	if ((mode & DWT_START_TX_DELAYED) || (mode & DWT_START_TX_DLY_REF) || (mode & DWT_START_TX_DLY_RS) || (mode & DWT_START_TX_DLY_TS))
	{
		...
		else
		{
            ...
            //then if the application wants to cancel the sending this can be done in a separate command.
		}
 ...
 * no return value
 */
void DW3000::dwt_forcetrxoff(void)
{
 ...
 * no return value
 */
void DW3000::dwt_setsniffmode(uint8_t enable, uint8_t timeOn, uint8_t timeOff)
{
	if (enable)
	{
 ...
 */
int DW3000::dwt_rxenable(int mode)
{
	uint8_t temp1;
 ...
 * no return value
 */
void DW3000::dwt_setrxtimeout(uint32_t time)
{
	if (time > 0)
	{
 ...
 * no return value
 */
void DW3000::dwt_setpreambledetecttimeout(uint16_t timeout)
{
 ...
 * no return value
 */
void DW3000::dwt_setinterrupt(uint32_t bitmask_lo, uint32_t bitmask_hi, dwt_INT_options_e INT_options)
{
	decaIrqStatus_t stat;
 ...
 * no return value
 */
void DW3000::dwt_configeventcounters(uint8_t enable)
{
 ...
 * no return value
 */
void DW3000::dwt_readeventcounters(dwt_deviceentcnts_t *counters)
{
	uint32_t temp;
 ...
 * no return value
 */
void DW3000::dwt_softreset(void)
{
 ...
 * no return value
 */
void DW3000::dwt_setxtaltrim(uint8_t value)
{
 ...
 */
uint8_t DW3000::dwt_getxtaltrim(void)
{
 ...
 *
 */
void DW3000::dwt_disable_rf_tx(uint8_t switch_config)
{
	// Turn off TX LDOs
 ...
 *
 */
void DW3000::dwt_enable_rf_tx(uint32_t channel, uint8_t switch_control)
{
	// Turn on TX LDOs
 ...
 *
 */
void DW3000::dwt_repeated_cw(uint8_t cw_enable, uint8_t cw_mode_config)
{
 ...
 * No return value
 */
void DW3000::dwt_repeated_frames(uint32_t framerepetitionrate)
{
 ...
 * No return value
 */
void DW3000::dwt_enable_rftx_blocks(uint32_t channel)
{
	if (channel == SEL_CHANNEL5)
	{
 ...
 * No return value
 */
void DW3000::dwt_disable_rftx_blocks(void)
{
 ...
 * no return value
 */
void DW3000::dwt_configcwmode(uint8_t channel)
{
 ...
 * no return value
 */
void DW3000::dwt_configcontinuousframemode(uint32_t framerepetitionrate, uint8_t channel)
{
 ...
 */
uint16_t DW3000::dwt_readtempvbat(void)
{
	uint8_t vbat_raw = 0;
	uint8_t temp_raw = 0;
	uint8_t ldo_ctrl;
 ...
 */
float DW3000::dwt_convertrawtemperature(uint8_t raw_temp)
{
	float realtemp;
 ...
 */
float DW3000::dwt_convertrawvoltage(uint8_t raw_voltage)
{
	float realvolt;
 ...
 */
uint8_t DW3000::dwt_readwakeuptemp(void)
{
 ...
 */
uint8_t DW3000::dwt_readwakeupvbat(void)
{
 ...
 */
uint8_t DW3000::dwt_calcbandwidthadj(uint16_t target_count, uint8_t channel)
{
 ...
 */
uint16_t DW3000::dwt_calcpgcount(uint8_t pgdly, uint8_t channel)
{
	uint16_t count = 0;
 ...
 * no return value
 */
void DW3000::dwt_configure_aes(const dwt_aes_config_t *pCfg)
{
	uint16_t tmp;
 ...
 */
dwt_mic_size_e DW3000::dwt_mic_size_from_bytes(uint8_t mic_size_in_bytes)
{
 ...
 * no return value
 */
void DW3000::dwt_set_keyreg_128(const dwt_aes_key_t *key)
{
 ...
 */
uint8_t DW3000::dwt_wait_aes_poll(void)
{
	uint8_t tmp;
	do
	{
 ...
 *
 */
void DW3000::dwt_update_nonce_CCM(uint8_t *nonce, uint16_t payload)
{
	uint8_t iv[16];
	iv[0] = nonce[10];
	iv[1] = nonce[9];
 ...
 *
 */
void DW3000::dwt_update_nonce_GCM(uint8_t *nonce)
{
 ...
 *
 */
int8_t DW3000::dwt_do_aes(dwt_aes_job_t *job, dwt_aes_core_type_e core_type)
{
 ...
 *
 */
void DW3000::dwt_configure_le_address(uint16_t addr, uint8_t leIndex)
{
	switch (leIndex)
	{
	case 0:
 ...
 *
 */
void DW3000::dwt_configuresfdtype(uint8_t sfdType)
{
