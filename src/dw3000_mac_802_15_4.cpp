...
// Macros, I don't know that we need them outside of this file, so I took them out of the header.
...
void MacFrame802_15_4::mac_frame_set_pan_ids_and_addresses_802_15_4(uint16_t dest_pan_id,
...
void MacFrame802_15_4::mac_frame_init_mac_frame_ctrl()
{
	/*
...
void MacFrame802_15_4::mac_frame_update_sequence_number(uint8_t seq_num)
{
...
void MacFrame802_15_4::mac_frame_set_AUX_security_control()
{
...
void MacFrame802_15_4::mac_frame_set_AUX_key_identifier(uint8_t key_index)
{
...
void MacFrame802_15_4::mac_frame_update_aux_frame_cnt(uint32_t frame_cnt)
{
	uint8_t cnt;

	for (cnt = 0; cnt < AUX_FRAME_CNT_SIZE; cnt++)
	{
		MAC_FRAME_AUX_FRAME_CNT_802_15_4(mac_frame_ptr, cnt) = (uint8_t)(frame_cnt);
		frame_cnt >>= 8;
	}
}

/* Get the key identifier value, in our case it is one byte - key index */
uint8_t MacFrame802_15_4::mac_frame_get_AUX_key_identifier()
{
...
uint32_t MacFrame802_15_4::mac_frame_get_aux_frame_cnt()
{
	int8_t cnt;
 ...
 *
 * */
void MacFrame802_15_4::mac_frame_get_nonce(uint8_t *aes_iv)
{
 ...
 * */
uint8_t MacFrame802_15_4::mac_frame_get_aux_mic_size()
{
	uint8_t value;
 ...
 * */
aes_results_e MacFrame802_15_4::rx_aes_802_15_4(
	DW3000 &radio,
	...
	dwt_aes_config_t *aes_config)
{
	...
	if ((frame_length - FCS_LEN) >= aes_job->header_len)
	{
		...
		radio.dwt_readrxdata((uint8_t *)MHR_802_15_4_PTR(mac_frame_ptr), aes_job->header_len, 0);

		/* Place a breakpoint here to see an unencrypted header */

		get_src_and_dst_frame_addr(&src_addr, &dst_addr);
		...
		aes_job->mic_size = mac_frame_get_aux_mic_size();
 ...
 */
security_state_e MacFrame802_15_4::get_security_state()
{
 ...
 * @return  None
 */
void MacFrame802_15_4::get_src_and_dst_frame_addr(uint64_t *src, uint64_t *dst)
{
